...
| Source filament objects | 5,039 |
| Color entries | 31,126 |
| Compiled filament variants | 53,351 |
| Source filaments with country of origin | 4,584 |
| Source filaments with TDS/product links | 1,130 |
