...
| Source filament objects | 5,038 |
| Color entries | 31,119 |
| Compiled filament variants | 53,344 |
| Source filaments with country of origin | 4,584 |
| Source filaments with TDS/product links | 1,128 |
